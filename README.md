...
1. Framework: **Other** (HTML estático)
1. Root Directory: `/`
1. Click **Deploy** ✅
...
1. Crea un proyecto → habilita **Google Drive API**
1. Crea credenciales OAuth 2.0 → copia el `client_id`
1. En `index.html`, reemplaza en `backupDrive()`:
...
1. Ver docs: https://developers.google.com/drive/api/guides/manage-uploads

### OneDrive (Microsoft)

1. Ve a [portal.azure.com](https://portal.azure.com)
1. Registra una app → copia el `client_id`
1. En `index.html`, reemplaza en `backupOneDrive()`:
...
1. Ver docs: https://learn.microsoft.com/graph/api/driveitem-put-content
